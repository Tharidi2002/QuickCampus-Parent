...
// API base URLs
const COURSE_SERVICE_URL = 'http://localhost:8081/course-service';
const STUDENT_SERVICE_URL = 'http://localhost:8082/student-service';
const MEDIA_SERVICE_URL = 'http://localhost:8083/media-service';
